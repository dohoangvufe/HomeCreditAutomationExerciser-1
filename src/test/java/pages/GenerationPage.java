...
public class GenerationPage extends BasePage{
    ...
    public void isGenerated(){
        Assert.assertEquals(pageTitle, Driver.getInstace().getTitle());
        System.out.println("Account Generated Successfully!");
        ((JavascriptExecutor)Driver.getInstace()).executeScript("arguments[0].style.border='3px solid red'",accountIdCell);
    }
