...
public class RegistrationPage extends BasePage {
    ...
    public void isRegistered(){
        Assert.assertEquals(Driver.getInstace().getTitle(),pageTitle);
        System.out.println("Customer Registered Successfully!");
        ((JavascriptExecutor)Driver.getInstace()).executeScript("arguments[0].style.border='3px solid red'",customerIdCell);
    }
